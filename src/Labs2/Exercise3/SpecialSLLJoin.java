...
public class SpecialSLLJoin<E> {
    ...
    public SLL<E> specialJoin(SLL<E> list1, SLL<E> list2) {
        ...
        while (tmpFirst.succ != null && tmpSecond.succ != null) {
            mergedList.insertLast(tmpFirst.element);
            mergedList.insertLast(tmpFirst.succ.element);
            mergedList.insertLast(tmpSecond.element);
            mergedList.insertLast(tmpSecond.succ.element);

            tmpFirst = tmpFirst.succ.succ;
            tmpSecond = tmpSecond.succ.succ;
